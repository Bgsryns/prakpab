                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-control" name="service" onchange="hitung()">
                                        @foreach ($services as $service)
                                                                            <option value="{{ $service['service'] }}" {{ $courier == $ccourier ?
        'SELECTED' : '' }}>
                                                                                {{ $service['service'] }}
                                                                            </option>
                                        @endforeach
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <input type="hidden" id="waktu_kirim" name="waktu_kirim"
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <input type="text" id="total_harga" name="total_harga" class="form-control" value="{{ $produk->harga +
    $cservice['ongkos_kirim'] }}" readonly />
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item text-end">
                            <button class="btn btn-primary">BELI</button>&nbsp;
                            <a href="{{ url('/transaksi/daftar_produk') }}" c lass="btn">KEMBALI</a>
                        </li>
                    </ul>
                </form>
            </div>
